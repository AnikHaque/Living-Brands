    ...
    <div className="flex flex-col px-4 lg:px-[100px] font-[sora]">
      ...
      <div className="flex justify-between mb-20">
        ...
        <div className=" w-[70%]">
          ...
          Pusti Chigura Rice brings you something truly special! We're thrilled to present our latest campaign featuring the glamorous Nusrat Faria, who’s here to make your Eid celebrations even more delightful. 🍚✨

In this exclusive OVC (Online Video Commercial), Nusrat Faria, a beloved actress and style icon, invites you to share your very own Eid special recipes made with Pusti Chigura Rice. Whether it’s a family favorite passed down through generations or a modern twist on a classic dish, we want to see what makes your Eid spread extraordinary!
          </p>{" "}
          <br />
        </div>
      </div>
      ...
      <iframe width="100%" height="100%" src="https://www.youtube.com/embed/KwLTb5k9Tlw?si=mmkivI22z_eRzsOv" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
    </div>
  );
};
